...
import trainers.vpt
import trainers.codol_multi_domain
import trainers.codol_single_domain
...
def reset_cfg(cfg, args):
    ...
    if args.embedding_dim:
        cfg.MODEL.BACKBONE.EMBEDDING_DIM = args.embedding_dim
...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.CoDoL = CN()
    cfg.TRAINER.CoDoL.N_CTX = 16  # number of context vectors
    cfg.TRAINER.CoDoL.N_DMX = 16  # number of context vectors
    cfg.TRAINER.CoDoL.PREC = "fp16"  # fp16, fp32, amp
    cfg.TRAINER.CoDoL.TYPE = "each"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--embedding-dim", type=int, default=1024, help="embedding-dim of dpl method")  
